...
@section('title', 'EMS Audit Schedule Details')
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">EMS Audit Schedule Details</h2>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">EMS Audit Schedule Details
                </li>
              </ol>
            </div>
          </div>
                  ...
                  <div class="col-xs-12">
                      <div class="card">
                          <div class="card-body collapse in">
                              <div class="card-block" id="divCardBlockEMS">
                                <div class="row">
                                  <div class="col-md-5">
                                      <h3>{{ $ems_schedule_details->title ?? '' }}</h3>
                                      <h6>Scope : {{ $ems_schedule_details->scope ?? '' }}</h6>
                                      <h6>Reference Stds : {{ $ems_schedule_details->reference_stds ?? '' }}</h6>
                                      <h6>Method : {{ $ems_schedule_details->method ?? '' }}</h6>
                                  </div>
                                  <!-- <div class="col-md-7">
                                ...
                                <div style="float: left;">  
                                      <select class="form-control" id="selFilterEMSStat">
                                ...
                                <br><br>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-xs" id="tblEMSchedules" width="100%">
                                        <thead>
                                            <tr id="trHeader">
                                                <th rowspan="2">No.</th>
                                                <th rowspan="2">
                                                ...
                                                <th rowspan="2" class="center-table-cell">Areas</th>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="form" method="post" id="frmSaveProcess">
                    ...
                    <div class="col-sm-12">
                      <div class="form-body">
                          ...
                          <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" name="audit_schedule_id" value="{{ $ems_schedule_details->id ?? '' }}">
                          </div>

                      </div>

                      <div style="float: left;">
                        <button type="button" class="btn btn-outline-info btnShowEMSProcessDetails">Add Process Details</button>
                        <button type="button" class="btn btn-outline-danger btnHideEMSProcessDetails" style="display: none;">Cancel</button>
                      </div>
              ...
              <div class="modal-body" id="divAddEMSProcessDetails" style="display: none;">
                    ...
                    <div class="col-sm-12">
                      <div class="form-body">
                          <div class="form-group">
                              ...
                              <select class="form-control select2 selAreas" name="areas[]" multiple="multiple" style="width: 100%;">
                                <!-- Code generated -->
                              </select>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2 selUsers selAddEMSSchedUsers" name="process_owners[]" multiple="multiple" style="width: 100%;">
                                <!-- Code generated -->
                              </select>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2 selUsers selAddEMSSchedUsers" name="internal_auditors[]" multiple="multiple" style="width: 100%;">
                                <!-- Code generated -->
                              </select>
                          </div>
                      </div>
                        ...
                        <div class="col-sm-12">
                          <div class="form-body">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label for="projectinput1">Process Owner</label>
                                  <input type="hidden" class="form-control" name="ems_schedule_id">
                                  <select class="form-control select2 selUsers selAddEMSSchedUsers" name="process_owners[]" multiple="multiple" style="width: 100%;">
                                    <!-- Code generated -->
                                  </select>
                              </div>
...
@section('js_content')
    <script type="text/javascript">
        ...
        let auditScheduleId = "{{ $ems_schedule_details->id ?? '' }}";
        $(document).ready(function(){
            ...
            $("#btnAddProcess").click(function(){
              ...
              $("#divAddEMSProcessDetails").hide();
              $(".btnShowEMSProcessDetails").hide();
              $(".btnHideEMSProcessDetails").hide();
            });
            ...
            $("#selFilterEMSStat").change(function(){
              GetTableEMSSchedByAuditScheduleId(auditScheduleId, $("#selFilterEMSStat").val());              
            });
            ...
            $(document).on('dblclick', '.tdEditProcess', function(){
              ...
              $("#divAddEMSProcessDetails").hide();
              $(".btnShowEMSProcessDetails").show();
              $(".btnHideEMSProcessDetails").hide();
              GetEMSProcessById(processId);

            });

            $(".btnShowEMSProcessDetails").click(function(){
              $("#divAddEMSProcessDetails").show();
              $(".btnHideEMSProcessDetails").show();
              $(this).hide();
              ...
              $("select[name='areas[]'", frmSaveProcessDetails).val('-1').trigger('change');
            });

            $(".btnHideEMSProcessDetails").click(function(){
              $("#divAddEMSProcessDetails").hide();
              $(".btnShowEMSProcessDetails").show();
              $(this).hide();
            });
            ...
            GetDepartmentByStat2(1, $(".selAreas"));

            frmSaveProcessDetails.submit(function(e){
              e.preventDefault();
              EMSSaveProcessDetails(frmSaveProcessDetails, btnSaveProcessDetails);
            });

            // PROCESS DETAIL YEARS

            $(document).on('dblclick', '.tdEditProcessDetails', function(){
              let emsScheduleId = $(this).attr('ems-schedule-id');
              ...
              $("input[name='ems_schedule_id'", frmEditProcessDetails).val(emsScheduleId);
              $("input[name='ems_schedule_id'", frmSaveYear).val(emsScheduleId);

              $("select[name='process_owners[]'", frmEditProcessDetails).val('-1').trigger('change');
              $("select[name='internal_auditors[]'", frmEditProcessDetails).val('-1').trigger('change');
              $("select[name='areas[]'", frmEditProcessDetails).val('-1').trigger('change');
              // $("input[name='process_id'", frmSaveProcess).val(processId);
              GetEMSProcessDetailsById(emsScheduleId);
            ...
            frmEditProcessDetails.submit(function(e){
              e.preventDefault();
              EMSSaveProcessDetails(frmEditProcessDetails, btnEditProcessDetails);
            });
            ...
            dtYears = $("#tblYears").DataTable({
                ...
                "serverSide" : true,
                "ajax" : {
                    url: "../view_ems_years_by_schedule_id",
                    "data": function (param){
                        param.ems_schedule_id = $("input[name='ems_schedule_id'", frmEditProcessDetails).val();
                    }
                },
                "columns":[
