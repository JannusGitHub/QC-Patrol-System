  ...
  <div class="navbar-wrapper">
    <div class="navbar-header" style="padding: 5px 5px;">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item"><a href="{{ route('home') }}" class="navbar-brand nav-link" style="padding: 1px 1px;"><center><img style="max-width: 150px; max-height: 40px; margin: 7px 1px;" alt="branding logo" src="{{ asset('public/images/QUADS LOGO2.PNG') }}" data-expand="{{ asset('public/images/QUADS LOGO.PNG') }}" data-collapse="{{ asset('public/images/QUADS LOGO2.PNG') }}" class="brand-logo "></center></a></li>
