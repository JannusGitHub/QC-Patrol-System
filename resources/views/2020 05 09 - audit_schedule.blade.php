                                    ...
                                    <table class="table table-bordered table-hover table-striped table-xs" id="tblAQMSchedules" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="center-table-cell thInternalAuditor">Internal Auditor</th>

                                                <!-- Auto generate here -->
                                                <!-- <th colspan="4" class="center-table-cell">FY 2019</th>
                                                <th colspan="4" class="center-table-cell">FY 2020</th> -->
                                            </tr>
                                            <!-- <tr>
...
@section('js_content')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            GetTableAQMSSchedByIdToEdit("{{ $aqms_schedule_details->id }}");
