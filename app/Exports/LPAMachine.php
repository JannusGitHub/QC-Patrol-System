...
class LPAMachine implements FromView, WithTitle, WithEvents
{
    /**
    ...
    */
    ...
    function __construct($data, $factor_item_list_machine)
    {
        $this->data = $data;
    ...
    public function view(): View {
        return view('exports.lpa_machine', ['data' => $this->data, 'factor_item_list_machine' => $this->factor_item_list_machine]);
    }
