      ...
      <div class="content-wrapper">
        ...
        <div class="content-body"><!-- Feather icons section start -->
          ...
          <!-- ------------------------ TUV AUDIT -------------- -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditTUVAuditCat" name="audit_category" disabled="disabled">
                                                <option value="ISO9001">ISO9001</option>
                                                <option value="IATF16949">IATF16949</option>
                                                <option value="ISO14001">ISO14001</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditTUVAuditPurpose" name="purpose_of_audit" disabled="disabled">
                                                <option value="Surveillance">Surveillance</option>
                                                <option value="Renewal">Renewal</option>
                                                <option value="Certification">Certification</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditTUVAuditRankClass" name="classification" disabled="disabled">
                                                <option value="NC">NC</option>
                                                <option value="OFI">OFI</option>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtEditTUVAuditStanClause" class="form-control" placeholder="Standard Clause" name="standard_clause" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="date" id="dateEditTUVAuditDateFrom" class="form-control" name="audit_date_from" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="date" id="dateEditTUVAuditDateTo" class="form-control" name="audit_date_to" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtEditTUVAuditAuditors" class="form-control" placeholder="Auditors" name="auditors" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="number" id="txtEditTUVAuditDeadSubDays" class="form-control" name="deadline_for_submission_days" value="0" min="0" disabled="disabled">
                                                </div>
                                                <div class="col-md-8">
                                                    <input type="date" id="dateEditTUVAuditDeadSub" class="form-control" name="deadline_for_submission" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="dateEditTUVAuditActDateSub" class="form-control" name="actual_date_of_submission" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Responsible Department</label>
                                            <select class="form-control select2" id="selEditTUVAuditResDept" name="responsible_department[]" style="width: 100%;" multiple="multiple" disabled="disabled">
                                                <!-- code generated -->
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" cols="10" rows="5" id="txtEditTUVAuditStmtOfNC" name="statement_of_nc" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="projectinput1">Objective Evidence</label>
                                            <textarea class="form-control" cols="10" rows="5" id="txtEditTUVAuditObjEvi" name="objective_evidence" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <!-- <input type="text" id="txtEditTUVAuditCorrPerInCharge" class="form-control" placeholder="Person In Charge" name="correction_person_in_charge"> -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Person In Charge</label>
                                                    <!-- <input type="text" id="txtEditTUVAuditConPerInCharge" class="form-control" placeholder="Person In Charge" name="containment_person_in_charge"> -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Person In Charge</label>
                                                    <!-- <input type="text" id="txtEditTUVAuditSysPerInCharge" class="form-control" placeholder="Person In Charge" name="systematic_person_in_charge"> -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div style="height: 80px;">
                                                        <center>
                                                            ...
                                                            <input type="file" class="form-control" id="fileEditTUVAuditCorrAct" name="img_corrective_action" accept=".jpg, .jpeg, .png" disabled="disabled">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" cols="10" rows="5" id="txtEditTUVAuditCorrAct" name="corrective_action" disabled="disabled"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                      ...
                      <div class="modal-body">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="projectinput1"><b>Systematic</b></label> <br>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtEditCusAuditCusName" class="form-control" placeholder="Customer Name" name="customer_name" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Auditors</label>
                                            <input type="text" id="txtEditCusAuditAuditors" class="form-control" placeholder="Auditors" name="auditors" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Process</label>
                                            <input type="text" id="txtEditCusAuditProcess" class="form-control" placeholder="Process" name="process" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtEditCusAuditEvalItem" class="form-control" placeholder="Evaluation Item" name="evaluation_item" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Classification / Rank</label>
                                            <select class="form-control" id="selEditCusAuditClassRank" name="classification" disabled="disabled">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="dateEditCusAuditDateFrom" class="form-control" name="audit_date_from" disabled="disabled">
                                            <input type="date" id="dateEditCusAuditDateTo" class="form-control" name="audit_date_to" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="number" id="txtEditCusAuditDeadSubDays" class="form-control" name="deadline_of_submission_days" value="0" min="0" disabled="disabled">
                                            </div>
                                            <div class="col-md-8">
                                                <input type="date" id="dateEditCusAuditDeadSub" class="form-control" name="deadline_of_submission" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Actual Date of Submission</label>
                                            <input type="date" id="dateEditCusAuditActDateSub" class="form-control" name="actual_date_of_submission" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditCusAuditResGroup" name="responsible_group" disabled="disabled">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Responsible Department</label>
                                            <select class="form-control select2" id="selEditCusAuditResDept" name="responsible_department[]" style="width: 100%;" multiple="multiple" disabled="disabled">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" cols="10" rows="10" id="txtEditCusAuditStmtOfFin" name="statement_of_findings" placeholder="Statement of Finding(s)" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileEditCusAuditIllu" name="img_illustration" accept=".jpg, .jpeg, .png" disabled="disabled">
                                            <textarea class="form-control" cols="10" rows="4" id="txtEditCusAuditIllu" name="illustration" placeholder="Illustration / Photo" disabled="disabled"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 selectUser" id="selEditCusAuditPerInCharge" name="person_in_charge" style="width: 100%;">
                                                          <!-- code generated -->
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div style="height: 80px;">
                                                        ...
                                                        <input type="file" class="form-control" id="fileEditCusAuditCorrAct" name="img_corrective_action" accept=".jpg, .jpeg, .png" disabled="disabled">
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" cols="10" rows="5" id="txtEditCusAuditCorrAct" name="corrective_action" placeholder="Close-Out Audit" disabled="disabled"></textarea>
            ...
            <div class="modal fade text-xs-left" id="modalSendCusBatchEmail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true" data-backdrop="static">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" id="tblSendCusBatchEmail">
                                <thead>
                                    <tr>
                                        <th>Audit Date</th>
                                        <th>Audit Category</th>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditIntAuditType" name="audit_type" disabled="disabled">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtEditIntAuditRepContNo" class="form-control" placeholder="Audit Report Control No." name="audit_report_control_no" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Business Process / Section / Supplier Name</label>
                                            <input type="text" id="txtEditIntAuditBusProcSecSupp" class="form-control" placeholder="Business Process / Section / Supplier Name" name="business_process" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput2">Audit Date</label>
                                            <input type="date" id="dateEditIntAuditDateFrom" class="form-control" name="audit_date_from" disabled="disabled">
                                            <input type="date" id="dateEditIntAuditDateTo" class="form-control" name="audit_date_to" disabled="disabled">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Auditors</label>
                                            <input type="text" id="txtEditIntAuditAuditors" class="form-control" placeholder="Auditors" name="auditors" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Auditees</label>
                                            <input type="text" id="txtEditIntAuditAuditees" class="form-control" placeholder="Auditees" name="auditees" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="dateEditIntAuditFindIssDate" class="form-control" placeholder="Audit Findings Issued Date" name="audit_findings_issued_date" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="projectinput1">Deadline of Submission</label>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="number" id="txtEditIntAuditDeadSubDays" class="form-control" name="deadline_of_submission_days" value="0" min="0" disabled="disabled">
                                            </div>
                                            <div class="col-md-8">
                                                <input type="date" id="dateEditIntAuditDeadSub" class="form-control" name="deadline_of_submission" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Actual Date of Submission</label>
                                            <input type="date" id="dateEditIntAuditActDateSub" class="form-control" name="actual_date_of_submission" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtEditIntAuditIsoAitfClause" name="iso_iatf_clause" placeholder="ISO / IATF Clause" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Category Of Findings</label>
                                            <select class="form-control" id="selEditIntAuditCatOfFind" name="category_of_findings" disabled="disabled">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Classification / Rank</label>
                                            <select class="form-control" id="selEditIntAuditClassRank" name="classification" disabled="disabled">
                                                <option disabled selected>--Select Classification--</option>
                                                <option value="1">OFI</option>
                                                <option value="2">Major NC</option>
                                                <option value="3">Minor NC</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Responsible Department</label>
                                            <select class="form-control select2" id="selEditIntAuditResDept" name="responsible_department[]" style="width: 100%;" multiple="multiple" disabled="disabled">
                                                <!-- code generated -->
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="projectinput1">Statement of Finding(s)</label>
                                            <textarea class="form-control" cols="10" rows="10" id="txtEditIntAuditStmtOfFin" name="statement_of_findings" placeholder="Statement of Finding(s)" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileEditIntAuditIllu" name="img_illustration" accept=".jpg, .jpeg, .png" disabled="disabled">
                                            <input type="hidden" name="current_img_illustration" id="txtEditIntAuditCurrIllu">
                                            <textarea class="form-control" cols="10" rows="4" id="txtEditIntAuditIllu" name="illustration" placeholder="Illustration / Photo" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Person In Charge</label>
                                                    <!-- <input type="text" id="txtEditIntAuditCorrPerInCharge" class="form-control" placeholder="Person In Charge" name="correction_person_in_charge"> -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Person In Charge</label>
                                                    <!-- <input type="text" id="txtEditIntAuditConPerInCharge" class="form-control" placeholder="Person In Charge" name="containment_person_in_charge"> -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Person In Charge</label>
                                                    <!-- <input type="text" id="txtEditIntAuditSysPerInCharge" class="form-control" placeholder="Person In Charge" name="systematic_person_in_charge"> -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Person In Charge</label>
                                            <select class="form-control select2 selectUser" id="selEditIntAuditPerInCharge" name="person_in_charge[]" style="width: 100%;" multiple="multiple">
                                                <!-- code generated -->
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileEditIntAuditCorrAct" name="img_corrective_action" accept=".jpg, .jpeg, .png" disabled="disabled">
                                            <input type="hidden" name="current_img_corrective_action" id="txtEditIntAuditCurrCorrAct">
                                            <textarea class="form-control" cols="10" rows="4" id="txtEditIntAuditCorrAct" name="corrective_action" placeholder="Close-Out Audit" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selEditSuppAuditType" name="audit_type" disabled="disabled">
                                                <option value="0" disabled selected>--Select Audit Type--</option>
                                                <option value="System">System</option>
                                                <option value="Process">Process</option>
                                                <option value="Product">Product</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Audit Report Control No.</label>
                                            <input type="text" id="txtEditSuppAuditRepContNo" class="form-control" placeholder="Audit Report Control No." name="audit_report_control_no" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Business Process / Section / Supplier Name</label>
                                            <input type="text" id="txtEditSuppAuditBusProcSecSupp" class="form-control" placeholder="Business Process / Section / Supplier Name" name="business_process" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput2">Audit Date</label>
                                            <input type="date" id="dateEditSuppAuditDateFrom" class="form-control" name="audit_date_from" disabled="disabled">
                                            <input type="date" id="dateEditSuppAuditDateTo" class="form-control" name="audit_date_to" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Auditors</label>
                                            <input type="text" id="txtEditSuppAuditAuditors" class="form-control" placeholder="Auditors" name="auditors" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Auditees</label>
                                            <input type="text" id="txtEditSuppAuditAuditees" class="form-control" placeholder="Auditees" name="auditees" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Audit Findings Issued Date</label>
                                            <input type="date" id="dateEditSuppAuditFindIssDate" class="form-control" placeholder="Audit Findings Issued Date" name="audit_findings_issued_date" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="projectinput1">Deadline of Submission</label>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="number" id="txtEditSuppAuditDeadSubDays" class="form-control" name="deadline_of_submission_days" value="0" min="0" disabled="disabled">
                                            </div>
                                            <div class="col-md-8">
                                                <input type="date" id="dateEditSuppAuditDeadSub" class="form-control" name="deadline_of_submission" value="<?php echo date('Y-m-d'); ?>" disabled="disabled">
                                            </div>
                                            <input type="date" style="display: none;" class="form-control" name="current_deadline_of_submission" id="dateEditSuppAuditCurrDeadSub" disabled="disabled">
                                            <input type="date" style="display: none;" class="form-control" name="created_at" id="dateEditSuppAuditCreatedAt" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Actual Date of Submission</label>
                                            <input type="date" id="dateEditSuppAuditActDateSub" class="form-control" name="actual_date_of_submission" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtEditSuppAuditIsoAitfClause" name="iso_iatf_clause" placeholder="QMS Criteria" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Category Of Findings</label>
                                            <select class="form-control" id="selEditSuppAuditCatOfFind" name="category_of_findings" disabled="disabled">
                                                <option disabled selected>--Select Category Of Findings--</option>
                                                <option value="RD">RD</option>
                                                <option value="DD">DDI</option>
                                                <option value="PD">PD</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Classification / Rank</label>
                                            <select class="form-control" id="selEditSuppAuditClassRank" name="classification" disabled="disabled">
                                                <option disabled selected>--Select Classification--</option>
                                                <option value="NC">NC</option>
                                                <option value="OFI">OFI</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="projectinput1">Responsible Department</label>
                                            <select class="form-control select2" id="selEditSuppAuditResDept" name="responsible_department[]" style="width: 100%;" multiple="multiple" disabled="disabled">
                                                <!-- code generated -->
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="projectinput1">Statement of Finding(s)</label>
                                            <textarea class="form-control" cols="10" rows="10" id="txtEditSuppAuditStmtOfFin" name="statement_of_findings" placeholder="Statement of Finding(s)" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileEditSuppAuditIllu" name="img_illustration" accept=".jpg, .jpeg, .png" disabled="disabled">
                                            <input type="hidden" name="current_img_illustration" id="txtEditSuppAuditCurrIllu">
                                            <textarea class="form-control" cols="10" rows="4" id="txtEditSuppAuditIllu" name="illustration" placeholder="Illustration / Photo" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileEditSuppAuditCorrAct" name="img_corrective_action" accept=".jpg, .jpeg, .png" disabled="disabled">
                                            <input type="hidden" name="current_img_corrective_action" id="txtEditSuppAuditCurrCorrAct">
                                            <textarea class="form-control" cols="10" rows="4" id="txtEditSuppAuditCorrAct" name="corrective_action" placeholder="Close-Out Audit" disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        function GetTUVAuditByIdToEdit(tuvAuditId){
            $.ajax({
                ...
                success: function(JsonObject){
                    ...
                    // $("#selEditTUVAuditCorrPerInCharge").val(JsonObject['tuv_audits'][0]['correction_person_in_charge']).trigger('change');
                    $("#dateEditTUVAuditCorrCommDate").val(JsonObject['tuv_audits'][0]['correction_commitment_date']);

                    // $("#selEditTUVAuditConPerInCharge").val(JsonObject['tuv_audits'][0]['containment_person_in_charge']).trigger('change');
                    $("#dateEditTUVAuditConCommDate").val(JsonObject['tuv_audits'][0]['containment_commitment_date']);

                    // $("#selEditTUVAuditSysPerInCharge").val(JsonObject['tuv_audits'][0]['systematic_person_in_charge']).trigger('change');
        ...
        function GetCusAuditByIdToEdit(cusAuditId){
            $.ajax({
                ...
                success: function(JsonObject){
                    ...
                    $("#selEditCusAuditPerInCharge").val(JsonObject['customer_audits'][0]['person_in_charge']).trigger('change');
        ...
        function GetSuppAuditByIdToEdit(suppAuditId){
            $.ajax({
                ...
                success: function(JsonObject){
                    ...
                    $("#selEditSuppAuditPerInCharge").val(JsonObject['supplier_audits'][0]['person_in_charge']).trigger('change');
