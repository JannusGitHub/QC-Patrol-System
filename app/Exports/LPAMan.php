...
class LPAMan implements FromView, WithTitle, WithEvents
{
    /**
    ...
    */
    ...
    function __construct($data, $factor_item_list)
    {
        $this->data = $data;
    ...
    public function view(): View {
        return view('exports.lpa_man', ['data' => $this->data, 'factor_item_list' => $this->factor_item_list]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($alignCenter, $borderThin, $font11, $font12, $fontArial, $data) {
                ...
                // Set Row Height
                $event->sheet->getRowDimension(14)->setRowHeight(29);
                $event->sheet->getRowDimension(15)->setRowHeight(29);
                $event->sheet->getRowDimension(30)->setRowHeight(29);
                $event->sheet->getRowDimension(34)->setRowHeight(29);
