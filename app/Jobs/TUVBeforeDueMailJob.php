...
class TUVBeforeDueMailJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            for($index = 0; $index < count($arr_responsible_department_id); $index++){
                ...
                $newTUVBatchMail = new SendTUVBatchMail($final_tuv_audits, $arr_responsible_department_name[$index], 'Test Email - TUV Audit Batch Alert (1 Day Before Due Date)');
