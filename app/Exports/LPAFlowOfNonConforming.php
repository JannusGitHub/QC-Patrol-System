...
class LPAFlowOfNonConforming implements FromView, WithTitle, WithEvents
{
    /**
    ...
    */
    ...
    function __construct($data, $factor_item_list_non_forming)
    {
        $this->data = $data;
    ...
    public function view(): View {
        return view('exports.lpa_non_conforming', ['data' => $this->data, 'factor_item_list_non_forming' => $this->factor_item_list_non_forming]);
    }


    public function title(): string
    {
        return 'LPA-FLOW OF NON-CONFORMING';
    }
