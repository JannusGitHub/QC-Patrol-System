		...
		<?php for($index = 0; $index < count($data->ar_finding_details); $index++): ?>
			<tr>
				...
				<td style="border: 1px solid black;">
					<!-- <center><img src="<?php echo e($path); ?>" style="max-width: 20px !important; max-height: 20px !important; min-width: 10px !important; min-height: 10px !important; width: 15px !important;" class="commonAuditImg"></center> -->
				</td>
...
</table><?php /**PATH /var/www/qc_patrol/resources/views/exports/audit_results.blade.php ENDPATH**/ ?>