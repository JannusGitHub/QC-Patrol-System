...
<body>
	...
	@if($noOfImpPlan > 0)
		...
		<br>
		<p>This is a gentle reminder that the Improvement Plan is due on <u>{{ $suppliers[count($suppliers) - 1]->deadline_of_submission }}</u></p>
	...
	@if($noOfCloseOut > 0)
		...
		<br>
		<p>This is a gentle reminder that the evidence of improvement plan is due on 
			<u>
