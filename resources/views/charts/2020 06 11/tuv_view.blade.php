<div class="row">
    <div class="col-sm-4">
        <div class="input-group">
            ...
            <input type="month" class="form-control" name="from" id="dateSearchTUVAuditFrom" value="<?php echo date('Y-m'); ?>" style="min-width: 70px;">
            <span class="input-group-addon">to</span>
            <input type="month" class="form-control" name="to" id="dateSearchTUVAuditTo" value="<?php echo date('Y-m'); ?>" style="min-width: 70px;">
